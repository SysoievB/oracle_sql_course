...
VALUES (1, 'John', 'Doe', 'jdoe@example.com', TO_DATE('2015-06-01', 'YYYY-MM-DD'), 1, 90000, 3)
INTO EMPLOYEES (employee_id, first_name, last_name, email, hire_date, job_id, salary, department_id)
VALUES (2, 'Jane', 'Smith', 'jsmith@example.com', TO_DATE('2017-08-15', 'YYYY-MM-DD'), 2, 75000, 1)
INTO EMPLOYEES (employee_id, first_name, last_name, email, hire_date, job_id, salary, department_id)
VALUES (3, 'Bob', 'Brown', 'bbrown@example.com', TO_DATE('2018-09-23', 'YYYY-MM-DD'), 3, 80000, 2)
INTO EMPLOYEES (employee_id, first_name, last_name, email, hire_date, job_id, salary, department_id)
VALUES (4, 'Alice', 'Jones', 'ajones@example.com', TO_DATE('2019-12-10', 'YYYY-MM-DD'), 4, 70000, 4)
INTO EMPLOYEES (employee_id, first_name, last_name, email, hire_date, job_id, salary, department_id)
VALUES (5, 'Charlie', 'Wilson', 'cwilson@example.com', TO_DATE('2016-05-18', 'YYYY-MM-DD'), 5, 65000, 5)
SELECT *
FROM dual;
